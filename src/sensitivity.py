...
vzlusat = df[df['CubeSat']=='VZLUSAT2'].reset_index(drop=True)
...
# axs[0,0].scatter(vzlusat['cr_peak_cutoff_890'],vzlusat['flux_1024'],label='VZLUSAT-2')
axs[0,0].set_xlabel('peak count rate for E = cutoff-890 keV [cnt/s]')
axs[0,0].set_ylabel('peak Fermi flux for E = 10-1000 keV [ph/cm2/s]')
...
axs[0,1].errorbar(grbalpha['cr_peak_cutoff_370'],grbalpha['flux_batse_1024'],
                  ...
                  fmt='o',capsize=3)
# axs[0,1].scatter(vzlusat['cr_peak_cutoff_370'],vzlusat['flux_batse_1024'],label='VZLUSAT-2')
axs[0,1].set_xlabel('peak count rate for E = cutoff-370 keV [cnt/s]')
axs[0,1].set_ylabel('peak Fermi flux for E = 50-300 keV [ph/cm2/s]')
...
axs[1,0].errorbar(grbalpha['cnt_t90_cutoff_890'],grbalpha['fluence'],
                  ...
                  fmt='o',capsize=3)
# axs[1,0].scatter(vzlusat['cnt_t90_cutoff_890'],vzlusat['fluence'],label='VZLUSAT-2')
axs[1,0].set_xlabel('total counts in T90 for E = cutoff-890 keV [cnt]')
axs[1,0].set_ylabel('Fermi fluence for E = 10-1000 keV [erg/cm2]')
...
axs[1,1].errorbar(grbalpha['cnt_t90_cutoff_370'],grbalpha['fluence_batse'],
                  ...
                  fmt='o',capsize=3)
# axs[1,1].scatter(vzlusat['cnt_t90_cutoff_370'],vzlusat['fluence_batse'],label='VZLUSAT-2')
axs[1,1].set_xlabel('total counts in T90 for E = cutoff-370 keV [cnt]')
axs[1,1].set_ylabel('Fermi fluence for E = 50-300 keV [erg/cm2]')
